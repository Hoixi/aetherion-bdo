...
const COMMANDS = [
  {
    ...
    options: [
      ...
      { type: 3, name: "class", description: "Sınıfın", required: true, choices: [
        { name: "Warrior", value: "warrior" }, { name: "Ranger", value: "ranger" },
        { name: "Sorceress", value: "sorceress" }, { name: "Berserker", value: "berserker" },
        { name: "Tamer", value: "tamer" }, { name: "Musa", value: "musa" },
        { name: "Maehwa", value: "maehwa" }, { name: "Valkyrie", value: "valkyrie" },
        { name: "Kunoichi", value: "kunoichi" }, { name: "Ninja", value: "ninja" },
        { name: "Wizard", value: "wizard" }, { name: "Witch", value: "witch" },
        { name: "Dark Knight", value: "dark_knight" }, { name: "Striker", value: "striker" },
        { name: "Mystic", value: "mystic" }, { name: "Lahn", value: "lahn" },
        { name: "Archer", value: "archer" }, { name: "Shai", value: "shai" },
        { name: "Guardian", value: "guardian" }, { name: "Hashashin", value: "hashashin" },
        { name: "Nova", value: "nova" }, { name: "Sage", value: "sage" },
        { name: "Corsair", value: "corsair" }, { name: "Drakania", value: "drakania" },
        { name: "Woosa", value: "woosa" }, { name: "Maegu", value: "maegu" },
        { name: "Scholar", value: "scholar" }, { name: "Dosa", value: "dosa" },
