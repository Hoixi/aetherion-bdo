...
import { TestShell, Card, Head, Empty, loadJson } from "@/components/app-shell";
    ...
    <TestShell
      ...
      aside={
        <>
          ...
          <Link href="/savaslar" className="t-tab">
            ...
            return (
              <div key={w.id} className="t-row px-5 py-3 flex items-center gap-3 flex-wrap">
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <Link href={`/savaslar/${w.id}`} className="t-tab" title="Savaş sayfası">
