...
import { TestShell, Card } from "@/components/test-shell";
    ...
    return (
      <TestShell title="Klana Başvur" subtitle="Başvurun bize ulaştı.">
        <Card hi className="max-w-lg p-8 text-center mx-auto">
          ...
          <Link href="/test" className="inline-flex items-center gap-2 text-[13px] transition-colors hover:opacity-80"
    ...
    >
      ...
      <form onSubmit={submit} className="space-y-4 max-w-3xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/test" className="text-[12px] transition-colors hover:opacity-80" style={{ color: "var(--t-faint)" }}>
            Vazgeç
          </Link>
        </div>
      </form>
